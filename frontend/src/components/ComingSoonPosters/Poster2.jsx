...
function LuxurySpec({ icon, label, value }) {
  return (
    <div className="flex flex-col items-center justify-center p-4 lg:p-2 bg-gradient-to-b from-[#1c1a16] to-[#0a0907] border border-[#362f21] rounded-lg relative overflow-hidden group hover:border-[#b38b45] transition-colors duration-500">
...
function MainSpec({ icon, title, value }) {
  return (
    <div className="flex items-center gap-4 bg-[#14120e]/80 border-b border-[#2e281b] pb-3 pt-2 lg:pb-1.5 lg:pt-1.5 px-2 hover:bg-[#1f1b14] transition-colors">
      <div className="w-10 h-10 lg:w-8 lg:h-8 rounded-full border border-[#4a3e26] bg-[#0d0b08] flex items-center justify-center text-[#d4af37] shadow-[inset_0_0_10px_rgba(212,175,55,0.1)]">
        {icon}
      </div>
...
export default function Poster2({ car }) {
  ...
  return (
    <div className="w-full relative shadow-[0_40px_80px_rgba(0,0,0,0.8)] rounded-xl overflow-hidden bg-[#050403] border border-[#2a2315] min-h-[260px] lg:min-h-[150px]">
      ...
      <div className="relative z-10 flex flex-col h-full lg:p-6 p-4">
        ...
        {/* --- HEADER --- */}
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-[#362e1c] pb-6 mb-8 lg:pb-3 lg:mb-4 relative">
          {/* Absolute deco line */}
        ...
        {/* --- BODY --- */}
        <div className="flex-1 flex flex-col lg:flex-row gap-8 lg:gap-4 items-center">
          ...
          <div className="flex-1 w-full flex flex-col items-center justify-center relative">
            ...
            <div className="relative w-full shadow-2xl z-20">
              {car.image ? (
                <img src={car.image} alt={car.title} className="w-[110%] h-auto -ml-[5%] object-contain max-h-[240px] lg:max-h-[220px] drop-shadow-[0_30px_40px_rgba(0,0,0,0.9)] transform scale-110 hover:scale-[1.15] transition-transform duration-[2s] ease-[cubic-bezier(0.25,1,0.5,1)]" />
              ) : (
            ...
            {/* Bold Name Under Car */}
            <div className="mt-8 lg:mt-4 text-center relative z-20 bg-black/40 px-8 py-3 lg:py-2 rounded-full border border-[#2b2416] backdrop-blur-md">
          ...
          <div className="w-full lg:w-[320px] shrink-0 flex flex-col gap-6 lg:gap-4">
            ...
            {/* Authenticity seal */}
            <div className="mt-auto flex items-center justify-center gap-3 pt-6 lg:pt-3 border-t border-[#362e1c]">
            ...
            {/* Notify Me Button */}
            <button className="w-full mt-2 lg:mt-1 py-3.5 lg:py-2 bg-gradient-to-r from-[#d4af37] via-[#ffedb3] to-[#d4af37] hover:from-[#e3be46] hover:via-[#fff1c4] hover:to-[#e3be46] text-[#14120e] lg:text-sm font-black uppercase tracking-widest rounded-md shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(212,175,55,0.5)] transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2">

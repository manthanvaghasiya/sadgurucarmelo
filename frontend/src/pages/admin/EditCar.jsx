    ...
    try {
      ...
      if (res.data.success && res.data.data) {
        ...
        if (res.data.source === 'gemini') {
          toast.success('Car details & specifications updated with Gemini AI! ✨', { id: toastId });
        } else {
          toast.success('Car details updated via Smart Pattern Parser! ⚡', { id: toastId });
        }
      }
    } catch (err) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (photos.length > 0) {
        ...
        compressedPhotos.forEach(photo => formData.append('images', photo));
      }
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="font-body text-xs text-text-muted mt-0.5">
                  Paste updated WhatsApp car text to auto-refresh Make, Model, Year, Price, Specs & Features.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="relative">
                <textarea
                  ...
                  placeholder="Paste WhatsApp message or updated car details here..."
                  rows={4}

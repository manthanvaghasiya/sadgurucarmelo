  ...
  const onSubmit = async (data) => {
    try {
      ...
      const payload = {
        ...
        source: data.source,
        urgency,
        assignedTo: data.assignedTo, // Using Admin selected salesman
      ...
      <header className="bg-surface border-b border-gray-100 px-4 sm:px-6 py-4">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="font-body text-xs text-text-muted uppercase tracking-wider">Lead Management</p>
            <h1 className="font-heading font-bold text-lg text-text">Assign New Lead</h1>
          </div>
          <div className="hidden sm:block text-right">
            <p className="font-body text-[10px] text-text-muted uppercase tracking-widest font-bold">Administrator</p>
          ...
          <div className="bg-surface rounded-2xl border border-gray-100 p-5 sm:p-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  {...register('assignedTo', { required: 'Please select a salesman to assign this lead to' })}
                  disabled={isFetchingSalesmen}
                ...
                >
                  <option value="">{isFetchingSalesmen ? 'Loading salesmen...' : 'Select a salesman...'}</option>
              ...
              {errors.assignedTo && <p className="text-red-500 text-xs font-body mt-1">{errors.assignedTo.message}</p>}
            </div>
          </div>

  ...
  return (
    <div className="bg-background min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden fixed top-[84px] left-0 right-0 z-[1000] px-4 pointer-events-none">
          <button
            onClick={() => setIsFilterOpen(true)}
            className="w-full flex items-center justify-center gap-2 bg-white/95 backdrop-blur-md text-primary border border-gray-100 py-3.5 rounded-2xl font-heading font-bold shadow-xl shadow-black/5 active:scale-[0.98] transition-all pointer-events-auto"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className={`
            fixed inset-0 z-[10001] lg:relative lg:inset-auto lg:z-auto lg:w-1/4 lg:block

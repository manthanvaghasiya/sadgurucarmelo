        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-surface rounded-2xl shadow-sm border border-gray-100 p-8">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <span className="font-heading font-semibold text-[11px] uppercase tracking-widest text-text-muted block mb-1">Business Hours (સમય)</span>
                    <p className="font-body text-sm font-medium text-text mb-1">
                      સોમવાર - રવિવાર: 9:00 AM થી 7:00 PM
                    </p>
                    <span className="font-body text-[13px] font-semibold text-accent">અમે અઠવાડિયાના તમામ દિવસો ખુલ્લા છીએ</span>
                  </div>
                </div>
          ...
          <div className="relative h-[600px] lg:h-auto bg-[#e2e8f0]/40 rounded-3xl overflow-hidden border border-gray-200">
            ...
            <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-auto bg-surface/90 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-white/20 max-w-sm flex flex-col gap-4">
              <div>
                <h3 className="font-heading font-bold text-lg text-text mb-1">તાત્કાલિક સપોર્ટ જોઈએ છે?</h3>
                <p className="font-body text-sm text-text-muted">અમારી <span className="font-semibold text-slate-800">Sales Team</span> સાથે WhatsApp પર સીધી વાત કરો.</p>
              </div>
              <a
